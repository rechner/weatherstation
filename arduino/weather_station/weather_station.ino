...
float windspeed = 0; // [mph instantaneous wind speed]
...
// Activated by the magnet and reed switch in the rain gauge, attached to input D2
{
  ...
  {
    dailyrainin += 0.2794; //Each dump is 0.2794mm (0.011") of water
...
float get_wind_speed()
{
  ...
  //local
  float wndspd = windClicks / deltaTime; //3 / 0.750s = 4
  windClicks = 0; //Reset and start watching for new wind
  lastWindCheck = millis();

  wndspd *= 2.40114; // each revolution is 2.4114 km/h

  /*Serial.println();
  Serial.print("Windspeed:");
  Serial.println(wndspd);*/
...
void printWeather()
{
  ...
  Serial.print((windgustdir / 360.0));
